 ...
 */
const DIGEST_STEP_REMINDER = 'Concise digest contract (applies to THIS turn): the user-facing final reply that ends this turn must BEGIN with the digest blockquote "> **摘要：** ..." exactly as defined in the Concise output style section of the system prompt — before any heading, table, or body text. Intermediate tool-loop narration between tool calls stays exempt. Task-completion reports, monitoring/progress confirmations (【进度】/账目/确认无误/明白), delivery talk-tracks (「图已生成…」「交付如下」), and replies ending in a user-facing question are NOT exempt.';
